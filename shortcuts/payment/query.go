...
// QueryShortcut defines the "payment +query" shortcut.
// GET /g2/v1/payment/mer/{sid}/payment?merchantTransID=<id>
func QueryShortcut() shortcuts.Shortcut {
	return shortcuts.Shortcut{
		Service:     "payment",
		Command:     "+query",
		Description: "Query payment status by merchant transaction ID",
